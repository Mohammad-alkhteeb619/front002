...
const HandleSolve = (id)=>{
  ...
  {t("Home Page")}
      ...
      <div className="mb-3">
        ...
        >
          <option className="codeemr" value="">{t("Select Code")}</option>
          {codes.map((code) => (
            <option className="code-type"
              key={code.id}
              value={code.id}
      ...
      <div className="mt-5">
        ...
        <table className="table">
          <tr style={{backgroundColor:"whitesmoke"}}>
            ...
            <th style={{ padding: "15px 20px",border: "1px solid white" }} colSpan={3}>{t("Broadcasted By")}</th>
            <th style={{ padding: "15px 20px" ,border: "1px solid white"}} colSpan={1}>{t("Department")}</th>
            <th style={{ padding: "15px 20px" ,border: "1px solid white"}} colSpan={1}>{t("Terminated")}</th>
          </tr>
